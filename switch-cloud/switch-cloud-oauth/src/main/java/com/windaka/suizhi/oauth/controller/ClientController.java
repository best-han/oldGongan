...
import com.windaka.suizhi.oauth.service.impl.RedisClientDetailsService;
...
*/
  ...
  //  @LogAnnotation(module = "删除client")
    ...
    private void checkSystemClient(String clientId) {
        if (OssClientInfo.CLIENT_ID.equals(clientId)) {
    ...
    private boolean isSystemClient(ClientDetails clientDetails) {
        ...
        boolean isSystem = OssClientInfo.CLIENT_ID.equalsIgnoreCase(baseClientDetails.getClientId());
