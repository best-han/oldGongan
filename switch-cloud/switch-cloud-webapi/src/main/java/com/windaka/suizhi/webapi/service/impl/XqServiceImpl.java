...
import com.windaka.suizhi.webapi.dao.XqWyRelationDao;
...
public class XqServiceImpl implements XqService {
	...
	public void saveXq(String wyCode,Xq xq) throws OssRenderException, IOException {
		...
		xqWyRelationDao.saveXqWyRelation(xq.getCode(),wyCode);
	...
	public Page<Map<String, Object>> queryXqList(Map<String, Object> params) throws OssRenderException {
		...
		if (totalRows > 0) {
			...
			for(Map map:list){
				map.put("manageLoginUrl",map.get("url")+ GlobalConstant.MANAGE_LOGIN_URL);
			}
		}
