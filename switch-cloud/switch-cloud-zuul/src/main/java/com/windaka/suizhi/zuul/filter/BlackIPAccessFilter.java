...
import com.windaka.suizhi.zuul.commons.ZuulTools;
import com.windaka.suizhi.zuul.feign.ManagePlatfromClient;
...
public class BlackIPAccessFilter extends ZuulFilter {
	...
	public boolean shouldFilter() {
		...
		String ip = ZuulTools.getIpAddress(request);
	...
	@Autowired
	private ManagePlatfromClient managePlatfromClient;
	...
	public void syncBlackIPList() {
		try {
			Set<String> list = managePlatfromClient.findAllBlackIPs(Collections.emptyMap());
			blackIPs = list;
		} catch (Exception e) {
			// do nothing
		}
